  ...
  return (
    <section className="home-section">
      <div className="section-content">
        ...
        <p className="instant-text">AI & Data Science Student | Aspiring Innovator</p>
        <p className="animate-text delay-1">
          Passionate about <span className="highlight">Machine Learning</span>.
        </p>
        <a href="./projects" className="cta-button animate-text delay-2">View My Work</a>
